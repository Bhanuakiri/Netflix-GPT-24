...
const Login = () => {
  ...
  return (
    ...
    <div className='absolute'>
     <img className="h-screen object-cover" src={Background_IMG} alt='bg'/>
    </div>
     <form className='w-full md:w-3/12 absolute p-12 my-36 bg-black mx-auto right-0 left-0 text-white rounded-lg bg-opacity-80'>
